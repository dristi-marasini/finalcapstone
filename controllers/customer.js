...
api.post('/save', (req, res) => {
  ...
  item._id = parseInt(req.body._id, 10) // base 10
	item.customerFirstName = req.body.customerFirstName
	
  item.customerMiddleName = req.body.customerMiddleName
	item.customerLastName = req.body.customerLastName
	item.customerAge=req.body.customerAge
